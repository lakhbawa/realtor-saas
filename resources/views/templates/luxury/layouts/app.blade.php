...
<head>
    ...
    <title>{{ $metaTitle ?? $site?->business_name ?? $tenant->name }} | Luxury Real Estate</title>
    <meta name="description" content="{{ $metaDescription ?? $site?->seo_settings['meta_description'] ?? 'Luxury real estate services' }}">
